...
$nameErr = $fnameErr = $mnameErr = $dobErr = $genderErr = $adharErr = $svErr = $cnameErr = $dnameErr = $snameErr = $conameErr = $pcodeErr = $phoneErr = $aphoneErr = $emailErr = $imgErr = $passErr = $cpassErr = "";

$staffName = $fName = $mName = $staffDob = $staffGender = $staffAdhar = $staffSVName = $staffCName = $staffDName = $staffSName = $staffCoName = $staffPCode = $staffPhone = $staffAphone = $staffEmail = $staffUserName = $staffPassword = $staffcPassword = "";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($_POST['staffPassword'])) {
        ...
        $staffPassword = htmlspecialchars($_POST['staffPassword']);
    }

    if (empty($_POST['staffCpassword'])) {
        $cpassErr = "*Enter Confirm Password";
    } else {
        $staffcPassword = htmlspecialchars($_POST['staffCpassword']);
    }
    ...
    if ($nameErr === "" and $fnameErr === "" and $mnameErr === "" and  $dobErr === "" and  $genderErr ===  "" and $adharErr === "" and  $svErr === "" and  $cnameErr === "" and  $dnameErr ===  "" and $snameErr === "" and  $conameErr ===  "" and $pcodeErr === "" and  $phoneErr ===  "" and $aphoneErr === "" and  $emailErr === "" and  $imgErr ===  "" and $passErr ===  "" and $cpassErr ===  "") {
        ...
        if ($imgErr === "") {
            ...
            $sql = "INSERT INTO staffDetails(staffName, fatherName, motherName, dob, gender, adharNo, svName,cityName, distName, stateName, countryName, pinCode, phoneNo, aPhoneNo, email, stType, doj, stImgName, username, password, updateDate) VALUES ('{$staffName}', '{$fName}', '{$mName}', '{$staffDob}', '{$staffGender}', '{$staffAdhar}', '{$staffSVName}', '{$staffCName}', '{$staffDName}', '{$staffSName}', '{$staffCoName}', '{$staffPCode}', '{$staffPhone}', '{$staffAphone}', '{$staffEmail}','{$stType}','{$date}', '{$fileName}', '{$staffUserName}', md5('{$staffPassword}'), '{$upDate}')";
...
<body>
                ...
                <div class="registration-form">
                    ...
                    <div class="input-box ">
                        <div class="input iptd">
                            ...
                            <input style="background-color: rgb(231, 231, 231);" readonly type="text" name="st-type" id="st-type" value="Technical">
                        </div>
                    ...
                    <div class="input-box non2">
                        <div class="input ip4 rel ">
                            ...
                            <div class="maint">
                                <input type="password" name="staffPassword" id="staffPassword" value="<?php echo $staffPassword; ?>">
                        ...
                        <div class="input ip4 rel ">
                            <label for="staffCpassword">Confirm Password </label>
                            <div class="maint">
                                <input type="password" name="staffCpassword" id="staffCpassword" value="<?php echo $staffcPassword; ?>">
    ...
    <script>
        let pass1 = document.querySelector("#staffPassword");
        let pass2 = document.querySelector("#staffCpassword");

    ...
    <main>
        ...
        <div class="student-det-con">
            ...
            if (isset($_GET['searchStudent'])) {
                ...
                $sql = "SELECT stuId, stuName, phoneNo, email, courseName FROM studentCourseDetails scd INNER JOIN studentDetails sd ON sd.id = scd.studentId INNER JOIN courseDetails cd ON cd.id = scd.courId WHERE stuId LIKE '%{$searchTerm}%' OR stuName LIKE '%{$searchTerm}%' ORDER BY studentId DESC";

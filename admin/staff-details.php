    ...
    <main>
        ...
        <div class="sdContainer staff-con ">
            <form style="margin-top: 25px;" class="search-course" action="searchstaff.php" method="GET">
                <input style="width: 45%;" type="search" name="searchStaff" id="search-course" required>
            ...
            <div class="staff-table staff-det-con2">
                <div class="table-data">
                    <table>
                        ...
                        $sql = "SELECT staffId, staffName, phoneNo, email, stType FROM staffDetails ORDER BY id DESC";
                        $result = mysqli_query($conn, $sql) or die("query failed");
                        if (mysqli_num_rows($result) > 0) {
                            $total = mysqli_num_rows($result);
                            echo " <div id='totalcourse'>
                                    <p>Total Staff - $total </p>
                                </div>";
